...
<p>Приєднуйтесь до нашої спільноти!</p>`,
    excerpt:
      "Вітаємо вас на нашій блог-платформі! Тут ви можете читати цікаві статті на різні теми.",
    authorId: "admin-1",
...
<p>Уникайте складних конструкцій, пишіть зрозуміло для читача.</p>`,
    excerpt:
      "Написання статей - це мистецтво, яке можна освоїти. Ось кілька порад для початківців.",
    authorId: "admin-1",
    authorName: "Адміністратор",
    status: "published",
...
export function getUsers(): User[] {
  ...
  if (!stored) {
    localStorage.setItem(
      USERS_KEY,
      JSON.stringify([{ ...DEFAULT_ADMIN, password: "admin123" }])
    );
